...
summaryButton.addEventListener("click", function() {
    ...
    summaryButton.classList.toggle("summary-red")
})
...
function horizontal(a) {
    const data = {
        ...
        datasets: [{
            indexAxis: 'y',
            data: [a.Hotspot.sub_group["By Pass Diode Issues"].Count + 200, a.Hotspot.sub_group["Dirt / Vegetation"].Count - 4000, a.Hotspot.sub_group["Broken Glass"].Count, a.Hotspot.sub_group.Others.Count - 300],
            fill: false,
            backgroundColor: [
                'rgba(22, 43, 224)',
                'rgba(4, 201, 93)',
...
function pie(a) {
    const data = {
        labels: [a.Hotspot.defect_type, a["Short Circuit"].defect_type, a["Open Circuit"].defect_type, a["Panel Failure"].defect_type, a.PID.defect_type],
        datasets: [{
            data: [a.Hotspot.Count - 4000, a["Short Circuit"].Count + 800, a["Open Circuit"].Count, a["Panel Failure"].Count + 600, a.PID.Count + 800],
            fill: false,
            backgroundColor: [
                "#f2de02",
...
function display(data) {
    ...
    diodeCount.classList.add("ml-auto", "main-names")
    ...
    dirtCount.classList.add("ml-auto", "main-names")
    ...
    glassCount.classList.add("ml-auto", "main-names")
    ...
    othersCount.classList.add("ml-auto", "main-names")
    ...
    shortCount.classList.add("ml-auto", "main-names")
    ...
    openCount.classList.add("ml-auto", "main-names")
    ...
    panelCount.classList.add("ml-auto", "main-names")
    ...
    moduleCount.classList.add("ml-auto", "main-names")
    ...
    tableCount.classList.add("ml-auto", "main-names")
    ...
    pidCount.classList.add("ml-auto", "main-names")
